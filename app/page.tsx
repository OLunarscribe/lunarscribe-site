  ...
  const features = useMemo(
    () => [
      ...
      },
      {
        ...
        title: "Integrations & data normalization",
        desc: "Bring in data from your tools, clean it, and keep it consistent.",
      },
      {
        icon: <Clock className="h-5 w-5" />,
        title: "Time-in-stage tracking",
        desc: "Automatically calculate bottlenecks and enforce accountability by owner and stage.",
      },
      {
        icon: <Shield className="h-5 w-5" />,
        title: "Permissions & governance",
        desc: "Role-based access, approvals, and change history.",
      },
      {
        icon: <FileDown className="h-5 w-5" />,
        title: "Exports that leadership trusts",
        desc: "Pull clean, structured data into Excel or your reporting layer.",
      },
      {
        icon: <Mail className="h-5 w-5" />,
        title: "Automated follow-ups",
        desc: "Nudges for overdue tasks, missing fields, and stalled work — so nothing silently dies.",
      },
    ],
    []
  );
    ...
    () => [
      {
        ...
        quote:
          "We finally have one place to see what’s stuck, who owns it, and what to do next. It killed the spreadsheet chaos.",
      },
      {
        name: "Founder",
        role: "Field + back office",
        quote:
          "Exports are clean and consistent. Finance stopped arguing about numbers because the source of truth is obvious.",
      },
      {
        name: "Project Manager",
        role: "High-volume ops",
        quote:
          "Time-in-stage changed everything. We found the real bottleneck in week one and fixed it.",
      },
    ],
    []
  );
    ...
    <div className="min-h-screen bg-[#05010f] text-white">
      ...
      <main className="relative z-10">
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              >
                ...
                dashboards, and automation that makes ownership obvious,
                bottlenecks visible, and reporting effortless.
              </motion.p>
            ...
            >
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5 shadow-2xl shadow-purple-900/20">
                ...
                <div className="mt-4 grid gap-3 md:grid-cols-2">
                  {["Pipeline", "Workload", "Aging", "Bottlenecks"].map((t) => (
                    <div
                      key={t}
                    ...
                    >
                      ...
                      <div className="mt-2 h-2 w-full rounded-full bg-white/10">
                        <div className="h-2 w-2/3 rounded-full bg-purple-300/70" />
                      </div>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-3 max-w-xl text-white/70">
                If your team lives in spreadsheets, Slack, and five tools that
                don’t agree, you don’t have a system. You have noise. Lunarscribe
                turns execution into a controlled, measurable workflow.
              </p>
          ...
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-white/70">
                Simple, fast, and focused on outcomes. You get a control tower
        ...
        <section id="pricing" className="mx-auto max-w-6xl px-6 pt-16 md:pt-20">
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-white/70">
                Choose the level of structure and support you want. Upgrade as
                your workflows expand.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-3xl border border-white/10 bg-white/5 p-6 text-sm text-white/70">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-2">
                ...
                <span>
                  Need strict governance, SSO, or custom integrations? Enterprise
                  is built for that.
                </span>
              </div>
              <Button
        ...
        <section id="testimonials" className="mx-auto max-w-6xl px-6 pt-16 md:pt-20">
          ...
          <p className="mt-2 max-w-2xl text-white/70">
            The point is simple: execution becomes visible, measurable, and
            consistent.
          </p>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 max-w-xl text-white/70">
                If you want to move faster, keep your stack lean, and still get
                clean reporting — this is for you.
              </p>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card className="rounded-3xl border-white/10 bg-white/5 text-white">
              <CardHeader>
                ...
                <CardDescription className="text-white/60">
                  Tell us your workflow and what you need exported. We’ll show
              ...
              <CardContent>
                <form onSubmit={onSubmit} className="space-y-3">
                  ...
                  <div className="text-xs text-white/60">
                    By submitting, you agree to be contacted about Lunarscribe.
                    No spam.
                  </div>
                </form>
              </CardContent>
